...
import Video4 from '../images/bg_9.mp4';
import Video5 from '../images/bg_10.mp4';
import Video6 from '../images/bg_11.mp4';

/**
 * Services Data Configuration
 * Centralized service information for easy maintenance
 * Used in Services page and service-related components
 */

// Primary Services (from 3Services.jsx)
...
// Additional Services (from 4Services.jsx)
...
export const allServices = [...primaryServices, ...additionalServices];

// Service categories for filtering (if needed)
